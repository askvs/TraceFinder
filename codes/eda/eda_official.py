"""
EDA (Exploratory Data Analysis) for Official Dataset
=====================================================
This script analyzes the Official scanner dataset to understand:
...
RESULTS_DIR = os.path.join(PROJECT_ROOT, "results", "eda", "official")
BATCH_SIZE = 32
...
def main():
    ...
    print("=" * 60)
    print("EDA - Official Dataset Analysis")
    print("=" * 60)
    ...
    plt.title("Official Dataset - Class Distribution", fontsize=14, fontweight='bold')
    plt.tight_layout()
    ...
    plt.suptitle("Sample Images from Official Dataset", fontsize=14, fontweight='bold')
    plt.tight_layout()
    ...
    plt.suptitle("One Sample Per Scanner Class", fontsize=14, fontweight='bold')
    plt.tight_layout()
    ...
    with open(report_path, 'w') as f:
        f.write("=" * 60 + "\n")
        f.write("EDA SUMMARY - Official Dataset\n")
        f.write("=" * 60 + "\n\n")
